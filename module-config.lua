...
key2App = {
    ...
    ['8'] = {'/Applications/Telegram Desktop.app', 'Chinese', 0},
    ['7'] = {'/Applications/TeamSpeak 3 Client.app', 'Chinese', 0},
    p = {'/System/Library/CoreServices/Finder.app', 'English', 0},
    o = {'/Applications/Emacs.app', 'English', 0},
    i = {'/Applications/iTerm.app', 'English', 0},
    k = {'/Applications/Firefox.app', 'English', 0},
    j = {'/Applications/Todoist.app', 'English', 0},
    b = {'/Applications/Visual Studio Code.app', 'English', 0},
    m = {'/Applications/iThoughtsX.app', 'Chinese', 0},
    n = {'/Applications/NeteaseMusic.app', 'English', 0},
}
